...
enum class DayOfWeek(@StringRes private val stringRes: Int) {
    MONDAY(R.string.monday), TUESDAY(R.string.thursday), WEDNESDAY(R.string.wednesday), THURSDAY(R.string.thursday), FRIDAY(R.string.friday), SATURDAY(R.string.saturday), SUNDAY(R.string.sunday);
